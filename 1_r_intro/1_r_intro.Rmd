...
We are not going to define our own functions today. Instead, we are going to use functions which other people have already defined for us - they have done the hard work!
...
We can also group a table by a variable.
